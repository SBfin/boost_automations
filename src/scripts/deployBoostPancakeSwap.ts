...
const PANCAKE_V3_POOL_ADDRESS = "0x1b3a07515800e8b16a46f67a6bab3d4e74148db0"; //COOKIE
const CHAIN_ID = 8453;
/*ZBU-OLAS*/
...
async function main() {
    ...
    const signature = "0x19b47279256b2a23a1665c810c8d55a1758940ee09377d4f8d26497a3577dc83" as `0x${string}`;
    ...
    for (const tokenAddress of token_array) {
        ...
        const actionStepSwap: ActionStep = {
            ...
            targetContract: PANCAKE_V3_POOL_ADDRESS as `0x${string}`,
            actionParameter: {
